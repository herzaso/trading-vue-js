<template>
  <div>
    <div id="test-title" :style="{ background: night ? null : '#fff' }">
      ...
      <a href="#" class="test-btn prev-test" v-on:click="prev_test">
        Prev test
      </a>
      <a href="#" class="test-btn next-test" v-on:click="next_test">
        Next test
      </a>
    </div>
    <div id="test-container">
      <component :is="current_test.name" :night="night" />
    </div>
  </div>
</template>
